...
%% Data
load('Shaka_T_interp_GSRM.mat');
load('Shaka_strain_rate.mat');
%%


%% Parameters
z = shaka_z_interp.*1e3; %m
T = shaka_T_interp + 273.15; %deg K
...
%% HT Mylonite
T_lower = 850 + 273.15; %deg K
T_upper = 900 + 273.15; %deg K
depth_lower = 19.5; %Corresponding depth from thermal model km
depth_upper = 21.2; %Corresponding depth from thermal model km
...
%% MT Mylonite
T_lower = 625 + 273.15; %deg K
T_upper = 675 + 273.15; %deg K
depth_lower = 13.6; %Corresponding depth from thermal model km
depth_upper = 14.8; %Corresponding depth from thermal model km
P_lower = (depth_lower.*1e3)*(density_rock-density_water)*g; 
P_upper = (depth_upper.*1e3)*(density_rock-density_water)*g; 
...
%% LT Mylonite
T_lower = 500 + 273.15; %deg K
T_upper = 550 + 273.15; %deg K
depth_lower = 10.7; %Corresponding depth from thermal model km
depth_upper = 11.8; %Corresponding depth from thermal model km
P_lower = (depth_lower.*1e3)*(density_rock-density_water)*g; 
P_upper = (depth_upper.*1e3)*(density_rock-density_water)*g;
